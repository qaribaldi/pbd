    ...
    public function simpan()
{
    ...
    $query = $db->query("CALL tambah_peminjaman(?, ?, ?, ?, ?)", [
        $nim, $nib, $tanggal_pinjam, $tanggal_kembali, $admin_id
    ]);
...
public function hapus($id)
{
    ...
    if ($data) {
        ...
        return redirect()->to('/lihat_data_buku')->with('error', 'Data tidak ditemukan');
    }
}
...
public function updateData($id)
{
    ...
    return redirect()->to('/peminjaman')->with('message', 'Data berhasil diperbarui');
}
