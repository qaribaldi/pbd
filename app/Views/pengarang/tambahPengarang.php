...
<body class="p-8 bg-amber-50 font-serif">
    <div class="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow-lg border border-gray-300">
        <h1 class="text-3xl font-bold mb-6 text-brown-800 text-center"><i class="fas fa-book"></i> Tambah Pengarang</h1>
        ...
        <div class="max-w-lg mx-auto">
            <form action="<?= base_url('simpan-pengarang') ?>" method="post">
                <div class="mb-4">
                    <label class="block text-gray-700">Id (Kode Pengarang)</label>
                    <input type="text" name="id_pengarang" required class="w-full px-3 py-2 border rounded-lg">
                </div>
                
                <div class="mb-4">
                    <label class="block text-gray-700">Nama Pengarang</label>
                    <input type="text" name="nama_pengarang" required class="w-full px-3 py-2 border rounded-lg">
                </div>
                
                <button type="submit" class="bg-emerald-700 text-white px-4 py-2 rounded-lg hover:bg-emerald-800">
                    <i class="fas fa-save"></i> Simpan Pengarang
                </button>
            </form>
        </div>
    </div>
